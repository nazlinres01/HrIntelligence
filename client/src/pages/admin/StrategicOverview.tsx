...
export default function StrategicOverview() {
  ...
  const totalPayrollAmount = payroll.reduce(
  ...
  const metrics = {
    ...
    quarterlyGrowthRate:
      companies.length > 0 ? (employees.length / companies.length) * 2.5 : 0,
    hrEfficiencyScore:
      employees.length > 0
        ? Math.min(95, 85 + (activeEmployees / employees.length) * 10)
        : 85,
    employeeSatisfactionScore: 4.2 + Math.random() * 0.6,
    employeeRetentionRate:
      employees.length > 0
        ? Math.min(95, 88 + (activeEmployees / employees.length) * 7)
        : 88,
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Kurumsal performans göstergeleri ve stratejik hedeflerin
                    kapsamlı analizi
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Button
                variant="outline"
                className="flex items-center gap-2 border-blue-500 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30"
              >
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <Tabs
          ...
          className="space-y-8"
        >
          <TabsList className="grid w-full grid-cols-4 lg:w-fit bg-blue-50 dark:bg-blue-900/20">
            <TabsTrigger
              value="overview"
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="flex items-center mt-2">
                        ...
                        <span className="text-sm text-blue-600">Mükemmel</span>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="flex items-center mt-2">
                        ...
                        <span className="text-sm text-blue-600">Üst Düzey</span>
                      </div>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900 dark:text-white">
                        {formatNumber(metrics.totalDepartments)}
                      </p>
                      <div className="flex items-center mt-2">
                        <ArrowUpRight className="h-4 w-4 text-blue-500" />
                        <span className="text-sm text-blue-600 ml-1">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900 dark:text-white">
                        {metrics.employeeSatisfactionScore.toFixed(1)}/5
                      </p>
                      <div className="flex items-center mt-2">
                        <ArrowUpRight className="h-4 w-4 text-blue-500" />
                        <span className="text-sm text-blue-600 ml-1">+0.3</span>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                          {formatPercentage(metrics.marketShare)}
                        </p>
                      </div>
                      <div className="w-32">
                        <Progress
                          value={metrics.marketShare * 4}
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                          {metrics.customerSatisfactionIndex.toFixed(1)}/5
                        </p>
                      </div>
                      <div className="w-32">
                        <Progress
                          value={metrics.customerSatisfactionIndex * 20}
                          className="h-2 bg-blue-100 [&>div]:bg-blue-600"
                        />
                      </div>
                    </div>
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                          {formatPercentage(metrics.operationalEfficiencyRatio)}
                        </p>
                      </div>
                      <div className="w-32">
                        <Progress
                          value={metrics.operationalEfficiencyRatio}
                          className="h-2 bg-blue-100 [&>div]:bg-blue-600"
                        />
                      </div>
                    </div>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <div>
                        <p className="text-sm font-medium text-gray-600 dark:text-gray-400">
                          Dijital Dönüşüm İlerlemesi
                        </p>
                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                          {formatPercentage(
                            metrics.digitalTransformationProgress,
                          )}
                        </p>
                      </div>
                      <div className="w-32">
                        <Progress
                          value={metrics.digitalTransformationProgress}
                          className="h-2 bg-blue-100 [&>div]:bg-blue-600"
                        />
                      </div>
                    </div>
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                          {formatPercentage(metrics.processAutomationLevel)}
                        </p>
                      </div>
                      <div className="w-32">
                        <Progress
                          value={metrics.processAutomationLevel}
                          className="h-2 bg-blue-100 [&>div]:bg-blue-600"
                        />
                      </div>
                    </div>
                    <div className="flex justify-between items-center">
                      <div>
                        <p className="text-sm font-medium text-gray-600 dark:text-gray-400">
                          Bulut Teknolojisi Benimsenmesi
                        </p>
                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                          {formatPercentage(metrics.cloudAdoptionRate)}
                        </p>
                      </div>
                      <div className="w-32">
                        <Progress
                          value={metrics.cloudAdoptionRate}
                          className="h-2 bg-blue-100 [&>div]:bg-blue-600"
                        />
                      </div>
                    </div>
              ...
              <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-semibold text-blue-600">
                      +{formatPercentage(metrics.quarterlyRevenueGrowth)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                ...
                <CardContent className="space-y-4">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-semibold text-blue-600">
                      {formatPercentage(metrics.sustainabilityScore)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <span className="text-sm font-semibold text-blue-600">
                      {metrics.innovationIndex.toFixed(1)}/5
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-semibold text-blue-600">
                      {metrics.cybersecurityMaturity.toFixed(1)}/5
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600 dark:text-gray-400">
                      Veri Analizi Olgunluğu
                    </span>
                    <span className="text-sm font-semibold text-blue-600">
                      {metrics.dataAnalyticsMaturity.toFixed(1)}/5
                    </span>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">
                    {formatPercentage(metrics.hrEfficiencyScore)}
                  </p>
              ...
              <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">
                    {formatPercentage(metrics.employeeRetentionRate)}
                  </p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Hedefin üzerinde
                  </p>
              ...
              <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">
                    {formatPercentage(metrics.quarterlyGrowthRate)}
                  </p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Beklentileri aşıyor
                  </p>
        ...
        {/* Action Items Footer */}
        <Card className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-blue-200 dark:border-blue-700 mt-8">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-gray-900 dark:text-white">
